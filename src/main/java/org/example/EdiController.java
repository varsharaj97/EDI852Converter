...
public class EdiController {
    ...
    @PostMapping("/convert")
    public ResponseEntity<Resource> convertEdiToCsv(@RequestParam("file") MultipartFile file) {
        /*if (file.isEmpty()) {
        ...
        try {
            ...
            // Process the file
            List<String> csvLines = ediConverter.processFile(file.getInputStream());
           ...
           /*String respDir = baseDir + File.separator + "data" + File.separator + "response" + File.separator;
            ...
            // 2. Convert List to a single CSV String (joining by newlines)
            String csvContent = csvLines.stream()
